...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> form ubah kata sandi tampil
- Location: tests\e2e\admin\admin-settings.spec.ts:55:7
...
Locator: locator('text="Ubah Kata Sandi"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Ubah Kata Sandi"')
