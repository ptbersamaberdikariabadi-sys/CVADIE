...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> section "Profil Perusahaan" dengan badge "Segera Hadir" tampil
- Location: tests\e2e\admin\admin-settings.spec.ts:66:7
...
Locator: locator('text="Profil Perusahaan"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Profil Perusahaan"')
