...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> tombol "Perbarui Kata Sandi" tersedia
- Location: tests\e2e\admin\admin-settings.spec.ts:62:7
...
Locator: locator('button:has-text("Perbarui Kata Sandi")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Perbarui Kata Sandi")')
