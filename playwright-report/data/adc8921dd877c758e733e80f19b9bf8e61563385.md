...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> header menampilkan "Pengaturan"
- Location: tests\e2e\admin\admin-settings.spec.ts:77:7
