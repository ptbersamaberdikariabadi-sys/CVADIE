...
- Name: admin\dashboard.spec.ts >> Admin Dashboard — /admin >> navigasi ke Katalog Produk dari sidebar berfungsi
- Location: tests\e2e\admin\dashboard.spec.ts:67:7
...
Call log:
  - waiting for locator('text="Katalog Produk"')
