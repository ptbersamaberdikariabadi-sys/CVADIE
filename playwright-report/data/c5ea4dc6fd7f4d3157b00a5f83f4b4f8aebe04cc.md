...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> deskripsi halaman pengaturan tampil
- Location: tests\e2e\admin\admin-settings.spec.ts:23:7
...
Locator: locator('text=/Kelola informasi profil/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Kelola informasi profil/i').first()
