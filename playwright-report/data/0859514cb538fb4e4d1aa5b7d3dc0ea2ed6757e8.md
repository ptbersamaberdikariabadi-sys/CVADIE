...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> kartu profil admin tampil dengan label "Administrator"
- Location: tests\e2e\admin\admin-settings.spec.ts:27:7
...
Locator: locator('text="Administrator"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Administrator"')
