...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> badge "Akses Penuh" tampil di profil admin
- Location: tests\e2e\admin\admin-settings.spec.ts:39:7
...
Locator: locator('text="Akses Penuh"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Akses Penuh"')
