...
- Name: admin\dashboard.spec.ts >> Admin Dashboard — /admin >> metric card "Total Prospek (RFQ)" tampil
- Location: tests\e2e\admin\dashboard.spec.ts:45:7
...
Locator: locator('text="Total Prospek (RFQ)"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Total Prospek (RFQ)"')
