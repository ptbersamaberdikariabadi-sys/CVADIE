...
- Name: admin\admin-cms.spec.ts >> Admin CMS Editor — /admin/cms >> konten CMS beranda bisa dilihat — setidaknya satu section tampil
- Location: tests\e2e\admin\admin-cms.spec.ts:39:7
...
Locator: locator('text=/Beranda/i').first().or(locator('text=/Hero/i').first()).or(locator('text=/Profil/i').first()).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/Beranda/i').first().or(locator('text=/Hero/i').first()).or(locator('text=/Profil/i').first()).first()
