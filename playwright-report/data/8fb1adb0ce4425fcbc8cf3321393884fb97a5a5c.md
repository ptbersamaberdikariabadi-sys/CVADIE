...
- Name: admin\admin-products.spec.ts >> Admin Form Tambah Produk — /admin/products/new >> tombol kembali ke daftar produk tersedia
- Location: tests\e2e\admin\admin-products.spec.ts:91:7
...
Locator: locator('a[href="/admin/products"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="/admin/products"]').first()
