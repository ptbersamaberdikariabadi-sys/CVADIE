...
- Name: admin\dashboard.spec.ts >> Admin Dashboard — /admin >> metric card "Total Produk Aktif" tampil
- Location: tests\e2e\admin\dashboard.spec.ts:49:7
...
Locator: locator('text="Total Produk Aktif"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Total Produk Aktif"')
