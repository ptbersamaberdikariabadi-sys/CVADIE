...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> section "Keamanan Akun" tampil
- Location: tests\e2e\admin\admin-settings.spec.ts:43:7
...
Locator: locator('text="Keamanan Akun"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Keamanan Akun"')
