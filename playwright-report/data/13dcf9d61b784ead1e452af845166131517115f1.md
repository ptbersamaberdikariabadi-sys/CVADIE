...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> sidebar navigasi tetap tampil di halaman settings
- Location: tests\e2e\admin\admin-settings.spec.ts:71:7
...
Locator: locator('aside').first().locator('text="ADIE ERP"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('aside').first().locator('text="ADIE ERP"')
