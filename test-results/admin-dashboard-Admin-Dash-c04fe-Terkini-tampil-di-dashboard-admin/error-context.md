...
- Name: admin\dashboard.spec.ts >> Admin Dashboard — /admin >> section Aktivitas Terkini tampil di dashboard
- Location: tests\e2e\admin\dashboard.spec.ts:57:7
...
Locator: locator('text="Aktivitas Terkini"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Aktivitas Terkini"')
