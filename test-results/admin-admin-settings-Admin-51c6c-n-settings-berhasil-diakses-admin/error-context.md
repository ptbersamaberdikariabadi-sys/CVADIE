...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> halaman settings berhasil diakses
- Location: tests\e2e\admin\admin-settings.spec.ts:14:7
...
Expected substring: "/admin/settings"
