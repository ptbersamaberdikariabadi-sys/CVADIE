...
- Name: admin\dashboard.spec.ts >> Admin Dashboard — /admin >> tombol Keluar (logout) tersedia di sidebar
- Location: tests\e2e\admin\dashboard.spec.ts:41:7
...
Call log:
  ...
  - waiting for locator('text="Keluar"')
