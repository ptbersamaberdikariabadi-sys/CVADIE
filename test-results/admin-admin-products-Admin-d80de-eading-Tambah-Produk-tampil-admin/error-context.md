...
- Name: admin\admin-products.spec.ts >> Admin Form Tambah Produk — /admin/products/new >> heading "Tambah Produk" tampil
- Location: tests\e2e\admin\admin-products.spec.ts:87:7
...
Locator: locator('text="Tambah Produk"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Tambah Produk"')
