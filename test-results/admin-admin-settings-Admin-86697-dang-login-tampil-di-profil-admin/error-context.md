...
- Name: admin\admin-settings.spec.ts >> Admin Pengaturan — /admin/settings >> email admin yang sedang login tampil di profil
- Location: tests\e2e\admin\admin-settings.spec.ts:31:7
...
Locator: locator('text=/abadidewana/i').first().or(locator('text=/@gmail.com/i').first()).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/abadidewana/i').first().or(locator('text=/@gmail.com/i').first()).first()
