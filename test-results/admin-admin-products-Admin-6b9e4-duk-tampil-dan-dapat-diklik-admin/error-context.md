...
- Name: admin\admin-products.spec.ts >> Admin Katalog Produk — /admin/products >> tombol "Tambah Produk" tampil dan dapat diklik
- Location: tests\e2e\admin\admin-products.spec.ts:28:7
...
Locator: locator('a:has-text("Tambah Produk")').first().or(locator('text="Tambah Produk"').first())
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("Tambah Produk")').first().or(locator('text="Tambah Produk"').first())
