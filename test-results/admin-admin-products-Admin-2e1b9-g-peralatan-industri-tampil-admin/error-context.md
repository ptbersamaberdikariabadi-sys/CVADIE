...
- Name: admin\admin-products.spec.ts >> Admin Katalog Produk — /admin/products >> sub-heading "peralatan industri" tampil
- Location: tests\e2e\admin\admin-products.spec.ts:24:7
...
Locator: locator('text=/peralatan industri/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/peralatan industri/i').first()
