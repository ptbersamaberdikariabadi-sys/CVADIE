...
- Name: admin\admin-rfq.spec.ts >> Admin RFQ — /admin/rfq >> heading "Daftar Prospek Masuk" tampil
- Location: tests\e2e\admin\admin-rfq.spec.ts:19:7
...
Locator: locator('text="Daftar Prospek Masuk"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Daftar Prospek Masuk"')
