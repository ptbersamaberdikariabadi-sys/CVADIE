...
- Name: admin\admin-products.spec.ts >> Admin Katalog Produk — /admin/products >> tabel produk memiliki kolom yang benar
- Location: tests\e2e\admin\admin-products.spec.ts:38:7
...
Locator: locator('th:has-text("SKU")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('th:has-text("SKU")')
