...
- Name: admin\admin-products.spec.ts >> Admin Katalog Produk — /admin/products >> sidebar navigasi tetap tampil
- Location: tests\e2e\admin\admin-products.spec.ts:69:7
