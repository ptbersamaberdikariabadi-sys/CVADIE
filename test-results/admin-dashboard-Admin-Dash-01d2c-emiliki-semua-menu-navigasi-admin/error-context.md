...
- Name: admin\dashboard.spec.ts >> Admin Dashboard — /admin >> sidebar memiliki semua menu navigasi
...
Locator: locator('aside').first().locator('text="Ikhtisar"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('aside').first().locator('text="Ikhtisar"')
