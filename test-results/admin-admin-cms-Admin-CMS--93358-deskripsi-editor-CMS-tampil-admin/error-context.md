...
- Name: admin\admin-cms.spec.ts >> Admin CMS Editor — /admin/cms >> deskripsi editor CMS tampil
- Location: tests\e2e\admin\admin-cms.spec.ts:23:7
...
Locator: locator('text=/Ubah teks/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Ubah teks/i').first()
