...
- Name: admin\dashboard.spec.ts >> Admin Dashboard — /admin >> metric card "Estimasi Konversi" tampil
- Location: tests\e2e\admin\dashboard.spec.ts:53:7
...
Locator: locator('text="Estimasi Konversi"')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text="Estimasi Konversi"')
